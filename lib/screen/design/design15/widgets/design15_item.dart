...
import 'package:barcontent/screen/design/design15/widgets/design15_item2.dart';
...
class _Design15ItemState extends State<Design15Item>
  ...
  Widget build(BuildContext context) {
    return GetBuilder<Design15Controller>(
      builder: (controller) {
        return controller.templateIndex == 1
            ? Container(
...
class Design15MainUI extends StatefulWidget {
  Map<String, dynamic> itemData;
  Design15MainUI({Key? key, required this.itemData}) : super(key: key);
...
class _Design15MainUIState extends State<Design15MainUI> {
  ...
  @override
  Widget build(BuildContext context) {
    return designController.templateIndex == 2
        ? Design15Item2(
            sec: 1,
            itemData: widget.itemData,
            titleText: 'Pakistan vs India',
          )
        : designController.templateIndex == 1
        ? Container(
            ...
            child: Column(
              ...
              children: [
                Expanded(
                  child: Design15Item(sec: 1, itemData: widget.itemData),
                ),
                Container(
        ...
        : Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Expanded(child: Design15Item(sec: 1, itemData: widget.itemData)),
              Container(
