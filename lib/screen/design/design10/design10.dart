...
class Design10 extends StatefulWidget {
  const Design10({super.key});

  @override
  State<Design10> createState() => _Design10State();
}

class _Design10State extends State<Design10> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: drawerWidget(),
      key: _Key,
      body: GetBuilder<Design10Controller>(builder: (controller) {
        return Stack(
          children: [
            Positioned(
              right: 50,
