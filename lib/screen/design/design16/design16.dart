...
class Design16 extends StatefulWidget {
  const Design16({super.key});

  @override
  State<Design16> createState() => _Design16State();
}

class _Design16State extends State<Design16> {
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      ValueChangeSlider(
                        ...
                        max: 1000,
                        title:
                            'Device Container Width: ${designController.picContainerWidth.toInt()}',
                        onChanged: (value) {
                      ...
                      ValueChangeSlider(
                        ...
                        max: 1000,
                        title:
                            'Device Container Height: ${designController.picContainerHeight.toInt()}',
                        onChanged: (value) {
                      ...
                      ValueChangeSlider(
                        ...
                        max: 100,
                        title:
                            'Device Space Top: ${designController.deviceMarginTop.toInt()}',
                        onChanged: (value) {
                          designController.deviceMarginTop = value;
                          designController.update();
                          setState(() {});
                        },
                      ),
                      ValueChangeSlider(
                        ...
                        max: 100,
                        title:
                            'Device Space Bottom: ${designController.deviceMarginBottom.toInt()}',
                        onChanged: (value) {
                          designController.deviceMarginBottom = value;
                          designController.update();
                          setState(() {});
                        },
                      ),
                      ...
                      ValueChangeSlider(
                        ...
                        max: 500,
                        title:
                            'Correct Icon Size: ${designController.correctIconSize.toInt()}',
                        onChanged: (value) {
                          designController.correctIconSize = value;
                          designController.update();
                          setState(() {});
                        },
                      ),
                      ValueChangeSlider(
                        ...
                        max: 200,
                        title:
                            'Correct Icon bottom Spacing: ${designController.correctIconBottom.toInt()}',
                        onChanged: (value) {
                          designController.correctIconBottom = value;
                          designController.update();
                          setState(() {});
                        },
                      ),
