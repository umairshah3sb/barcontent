...
class Design7Item extends StatefulWidget {
  ...
  @override
  State<Design7Item> createState() => _Design7ItemState();
}

class _Design7ItemState extends State<Design7Item> {
  Design7Controller designController = Get.put(Design7Controller());
