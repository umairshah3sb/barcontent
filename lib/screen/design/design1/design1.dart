...
class _Design1State extends State<Design1> {
  ...
  final design1Controller designController = Get.put(design1Controller());
        ...
        child: Column(
          children: [
                ...
                child: FittedBox(
                  child: Text(
                    ...
                    style: GoogleFonts.manrope(
                      ...
                      fontSize: designController.nameFontSize,
                      fontWeight: FontWeight.w900,
                      shadows: [
                        Shadow(
            ...
            Container(
              child: Container(
                width: width,
                height: designController.roleContainerHeight,
                decoration: BoxDecoration(
                  color: designController.roleContainerColor,
                  boxShadow: shadow,
                ),
                child: Center(
                  child: Text(
                    data['role'].toString().replaceAll(',', '\n'),
                    style: GoogleFonts.manrope(
                      color: designController.roleFontColor,
                      fontWeight: FontWeight.w900,
                      fontSize: designController.roleTextSize,
                    ),
                    textAlign: TextAlign.center,
                  ),
                ),
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      FontSizer(
                        hintText: 'Name Container Height',
                        fontSize: designController.nameContainerHeight.toInt(),
                        increase: () {
                          designController.nameContainerHeight++;
                          setState(() {});
                        },
                        decrease: () {
                          designController.nameContainerHeight--;
                      ...
                      FontSizer(
                        hintText: 'Role Text Font Size',
                        fontSize: designController.roleTextSize.toInt(),
                        increase: () {
                          designController.roleTextSize++;
                          setState(() {});
                        },
                        decrease: () {
                          designController.roleTextSize--;
                      ...
                      FontSizer(
                        hintText: 'Role Container Height',
                        fontSize: designController.roleContainerHeight.toInt(),
                        increase: () {
                          designController.roleContainerHeight++;
                          setState(() {});
                        },
                        decrease: () {
                          designController.roleContainerHeight--;
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      ColorPickerItem(
                        hintText: 'Role Text Color',
                        pickerTap: () {
                          colorPicker(
                            currentColor: designController.roleFontColor,
                            onChange: (color) {
                              designController.roleFontColor = color;
                            },
                            onPressed: () {
                              Navigator.of(context).pop();
                              setState(() {});
                      ...
                      ColorPickerItem(
                        hintText: 'Role Text Container',
                        pickerTap: () {
                          colorPicker(
                            currentColor: designController.roleContainerColor,
                            onChange: (color) {
                              designController.roleContainerColor = color;
                            },
                            onPressed: () {
                              Navigator.of(context).pop();
                              setState(() {});
